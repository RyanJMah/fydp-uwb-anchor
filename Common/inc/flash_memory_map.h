 ...
 *  --------------------------------
 *  |                              |
 *  |      Config Data Storage     |    8 kB    (0x0000 5000 - 0x0000 6FFF)
 *  |         (2 pages)            |
 *  |                              |
 *  --------------------------------
 *  |                              |
...
#define FLASH_APP_SIZE                  ( MCU_FLASH_SIZE - FLASH_BOOTLOADER_SIZE - FLASH_CONFIG_DATA_SIZE )
...
#if ( FLASH_BOOTLOADER_SIZE + FLASH_CONFIG_DATA_SIZE + FLASH_APP_SIZE ) != MCU_FLASH_SIZE
